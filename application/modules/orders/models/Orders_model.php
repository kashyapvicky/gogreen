<?php
  Class Orders_model extends CI_Model
  {
    ...
    {
      $this->db->select('up.id as primary_id,up.status,up.orders_id,up.net_paid,up.user_id,up.remark,up.transaction_id,up.status as payment_status,users.id as user_id,users.name as username,users.phone_number,t.name as team_name,t.id,ct.name as city,lt.name as locality,st.name as street,bp.purchase_date');
